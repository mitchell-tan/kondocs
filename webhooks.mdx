...
2. Manual — unselect 'general-update' to only fire events when you manually select conversations and syncAfter you create your first webhook destination, you will see a sync ⚡ button at the top of each chat or when selecting conversations in the inbox with the checkboxes

   ![](/CleanShot2025-03-03at18.55.52.png)

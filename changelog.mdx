...
<Update label="Nov 10, 2025" description="😇 Improvement">
  ## Sales Nav search

  Message search (shortcut /) now searches Sales Nav chats too for users on the Business plan
</Update>

<Update label="Nov 5, 2025" description="😇 Improvement">
  ## Filter by label

  You can now filter the Connections tab by Label.
</Update>

<Update label="Oct 26, 2025" description="✨ New Feature">
  ## Sales Nav inbox

  You can now see Sales Nav messages separately in the Sales Nav inbox, accessible in the left tabs menu.
</Update>

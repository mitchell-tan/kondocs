...
description: "How to share access to your Kondo account with teammates"
---
...
* Sign in to your Kondo account (tied to Google, found in [app.trykondo.com/settings](http://app.trykondo.com/settings))

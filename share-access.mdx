---
title: "Install Kondo desktop app"
---

You can install Kondo as a desktop app via Chrome, Edge, or Brave. Simply go to app.trykondo.com and you should see an icon to install it in the address bar.
